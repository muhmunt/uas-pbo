            ...
            <div class="mt-12">
                @foreach ($data as $todo)
                    <div
                        ...
                        <div
                            class="inline-block w-[1.25rem] min-w-[1.25rem] max-w-[1.25rem] h-[1.25rem] min-h-[1.25rem] max-h-[1.25rem] border-2 border-solid border-dark bg-dark rounded-full">
                        </div>
                    ...
                    <div
                        class="flex items-center border-2 border-solid border-dark rounded cursor-pointer select-none h-14 pl-5 pr-2 mb-4 hover:bg-warning">
                        <div
                            class="inline-block w-[1.25rem] min-w-[1.25rem] max-w-[1.25rem] h-[1.25rem] min-h-[1.25rem] max-h-[1.25rem] border-2 border-solid border-dark bg-white rounded-full">
                        </div>
                        <div class="grow text-ellipsis whitespace-nowrap overflow-hidden mx-4">
